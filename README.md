...
Now that you have all the blendshapes renamed and the merged blendshapes working, **be sure to save this file as a “.ma” (maya ASCII) file for running python script later on!**
